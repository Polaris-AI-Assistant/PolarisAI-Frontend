      ...
      <div className="relative w-full mt-14">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mx-auto mb-12 max-w-3xl">
            ...
            <div className="hidden subtitle inline-flex items-center rounded-full p-1" style={{ background: "rgba(255,255,255,0.03)" }}>
              <button
          ...
          <div className="w-full grid grid-cols-1 gap-6 md:grid-cols-3 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
