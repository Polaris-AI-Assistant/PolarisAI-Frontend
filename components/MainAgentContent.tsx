...
export const PreviewContentRenderer = ({ content, actionType, agentName }: { content: string; actionType?: string; agentName?: string }) => {
...
export const CollapsibleConfirmedAction = ({ 
  content, 
  actionType, 
  agentName, 
  description 
