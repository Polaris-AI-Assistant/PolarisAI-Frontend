            ...
            <DropdownMenu onOpenChange={setIsOpen}>
                <div className="group relative">
                    <DropdownMenuTrigger asChild>
                        <button
                            type="button"
                            className="flex items-center gap-16 p-3 rounded-2xl bg-zinc-900/40 backdrop-blur-md border border-zinc-800/50 hover:border-zinc-700/70 hover:bg-zinc-800/50 hover:shadow-lg hover:shadow-black/20 transition-all duration-200 focus:outline-none"
                        >
                            ...
                            <div className="relative">
                                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#C2185B' }}>
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={4}
                        className="w-64 p-2 bg-zinc-900/95 backdrop-blur-xl border border-zinc-800/60 rounded-2xl shadow-2xl shadow-black/40
