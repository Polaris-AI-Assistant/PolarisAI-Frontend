...
function GmailCallbackContent() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      console.log('Gmail callback params:', { success, error, errorDescription, email });
      ...
      if (success === 'true') {
        setStatus('success');
        setMessage(`Gmail connected successfully!${email ? ` (${email})` : ''} You can now fetch and embed your emails from the dashboard.`);
      ...
      setStatus('error');
      setMessage('Unexpected response from Gmail OAuth. Please try again.');
